function FixEpiSnippetPlusAgeCat(userid)
...
theFiles = dir(filePattern);
    ...
    for k = 1 : length(theFiles)    
        ...
        if(~strcmp(gAgeCat, 'No Data'))
            epiAnno.epiSnippetPlus.gAgeCat = strtrim(table2array(gAgeCat(1,1)));        
            epiSnippetPlus = epiAnno.epiSnippetPlus;
            save(fullFileName, 'epiSnippetPlus');   
        end % if SQL return gAgeCat
    end %EEG-snippets
