...
function out = qIEDScorePipeline(electrode,sample)
    ...
    str_z = sprintf('%0.2f', spiketobackground); 
    ...
    resultCrit2FFT = strcat(['SpikeToBackground: ',str_z]);
    ...
    fheight=500;
    f = figure('Name', 'Is this the IED you are looking for?','Position',[300,50,450,fheight]);    
    %resultinfo1 = uicontrol('Style','text', 'String',resultsharp,'Position',[50,fheight-200,400,20]);
    resultinfo2 = uicontrol('Style','text', 'String',resultonslope,'Position',[50,fheight-200,400,20]);
    resultinfo3 = uicontrol('Style','text', 'String',resultCrit2FFT,'Position',[50,fheight-225,400,20]);
    ...
    resultinfo6 = uicontrol('Style','text', 'String',resultdescamp,'Position',[50,fheight-250,400,20]);
    resultinfo7 = uicontrol('Style','text', 'String',resultslow,'Position',[50,fheight-275,400,20]);    
    resultinfo8a = uicontrol('Style','text', 'String','Enter age (integer):','Position',[50,fheight-300,200,20]);
    resultinputage = uicontrol('Style','edit', 'String','Skip age','Position',[50,fheight-325,200,20],'Callback',@agebutton_Callback);
    resultinfo9a = uicontrol('Style','text', 'String','Enter number of channels (integer):','Position',[50,fheight-350,240,20]);
    resultinputnumchan = uicontrol('Style','edit', 'String',resultnumchanstr,'Position',[50,fheight-375,240,20],'Callback',@numchanbutton_Callback);
    resultinfo10a = uicontrol('Style','text', 'String','Enter focus ID (integer):','Position',[50,fheight-400,240,20]);
    resultinputfocusid = uicontrol('Style','edit', 'String',resultfocusidstr,'Position',[50,fheight-425,240,20],'Callback',@focusidbutton_Callback);
    resultinfoBEMS = uicontrol('Style','text', 'String','BEMS: ','Position',[50,fheight-450,400,20]);
    savebutton = uicontrol('Style','pushbutton', 'String','Save and close','Position',[50,fheight-475,200,20],'Callback',@savebutton_Callback);
    ha = axes('Units','pixels','Position',[5,fheight-220,440,200]);
    align([savebutton,resultinfo2,resultinfo3,resultinfo6,resultinfo7,resultinfo8a,resultinputage,resultinfo9a,resultinputnumchan, resultinfo10a, resultinputfocusid, resultinfoBEMS],'Center','None');
    f.Units = 'normalized';
    ha.Units = 'normalized';
