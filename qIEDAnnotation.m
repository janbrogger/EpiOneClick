...
function out = qIEDScorePipeline(electrode,sample)
    ...
    fheight=700;
    f = figure('Name', 'Is this the IED you are looking for?','Position',[300,300,450,fheight]);    
    ...
    resultinfo3 = uicontrol('Style','text', 'String',resultCrit2FFT,'Position',[50,fheight-250,400,20]);
