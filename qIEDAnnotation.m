...
function out = qIEDAnnotation(electrode,sample)
    ...
    savebutton = uicontrol('Style','pushbutton', 'String','Save and close','Position',[50,fheight-300,200,20],'Callback',@savebutton_Callback);
    ha = axes('Units','pixels','Position',[5,fheight-220,440,200]);
    align([savebutton,resultinfo2,resultinfo3,resultinfo6,resultinfo7],'Center','None');
    f.Units = 'normalized';
    ha.Units = 'normalized';
